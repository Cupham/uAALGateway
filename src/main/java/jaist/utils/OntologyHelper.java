...
import jaist.echonet.objects.eAirConditioner;
import jaist.echonet.objects.eCurtain;
import jaist.echonet.objects.eElectricConsent;
import jaist.echonet.objects.eLighting;
import jaist.echonet.objects.eTemperatureSensor;
...
public class OntologyHelper {
	...
	public static void  initTemperatureSensorOntology(eTemperatureSensor dev, TemperatureSensor ont) {
		...
		if(dev.isOperationStatus()) {
			ont.setOperationStatus(OperationStatusValue.On);
		} else {
			ont.setOperationStatus(OperationStatusValue.Off);
		}
		
		MeasuredValue value = new MeasuredValue(MeasuredValue.MY_URI);
		value.setMeasuredValue(new Float(dev.getTemperature()));
		value.setMeasurementType(ValueCategory.TemperatureValue);
		value.setMeasuredUnit("Degree Celcius");
		//System.out.println("STT " +  ont.getProperty(TemperatureSensor.PROPERTY_HAS_OPERATION_STATUS));
		ont.setMeasuredMeasuredValue(value);
		if("Living room".equals(dev.getInstallLocation())) {
			ont.setInstallationLocation(InstallationLocationValue.LivingRoom);
		}
		...
		LOGGER.info("Init TEMP_TIME " + time);
	}
	public static void  updateTemperatureOntologyProperty(eTemperatureSensor dev, TemperatureSensor ont,String property) {
		...
		if(property.equals(TemperatureSensor.PROPERTY_HAS_OPERATION_STATUS)) {
			ont.changeProperty(TemperatureSensor.PROPERTY_HAS_OPERATION_STATUS, dev.isOperationStatus());
			//System.out.println("STT " +  ont.getProperty(TemperatureSensor.PROPERTY_HAS_OPERATION_STATUS));
		}
		
		
		if(property.equals(TemperatureSensor.PROPERTY_HAS_MEASURED_TEMPERATURE_VALUE)) {
			ont.changeProperty(TemperatureSensor.PROPERTY_HAS_MEASURED_TEMPERATURE_VALUE, dev.isOperationStatus());
			//System.out.println("VALUE " +  ont.getProperty(TemperatureSensor.PROPERTY_HAS_MEASURED_TEMPERATURE_VALUE));
		}
	...
	public static void  initHomeAirconditionerOntology(eAirConditioner dev, HomeAirConditioner ont) {
		...
		ont.changeProperty(HomeAirConditioner.PROPERTY_HAS_OPERATION_STATUS, dev.isOperationStatus());
	...
	public static void  initLightingOntology(eLighting dev, GeneralLighting ont) {
		...
		ont.changeProperty(GeneralLighting.PROPERTY_HAS_OPERATION_STATUS,dev.isOperationStatus());
		...
		ont.changeProperty(GeneralLighting.PROPERTY_HAS_INSTALLATION_LOCATION,dev.getInstallLocation());
	...
	public static void  initConsentntology(eElectricConsent dev, Switch ont) {
		...
		ont.changeProperty(Switch.PROPERTY_HAS_INSTALLATION_LOCATION,dev.getInstallLocation());
