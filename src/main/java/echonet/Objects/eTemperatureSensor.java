			...
			service.doGet(node, eoj, epcs, 5000, new GetListener() {
			    ...
			    public void receive(GetResult result, ResultFrame resultFrame, ResultData resultData) {
					...
					case x80:
						...
						String setOperationStatusLog = String.format("Temperature Sensor:%s {EPC:0x80, EDT: 0x%02X}=={OperationStatus:%s}",
					...
					case xE0:
						...
						String setTemperatureLog = String.format("Temperature Sensor:%s {EPC:0xE0, EDT: 0x%02X%02X}=={Temperature:%.2f}",
