...
public class HomeResourceObserver extends DataChangeObserver{
	...
	public void dataUpdated(Object obj, String property) {
		if(obj.getClass().equals(eTemperatureSensor.class)) {
			...
			String URI = TemperatureSensor.MY_URI +uriSuffix;		
			...
			String URI = HomeAirConditioner.MY_URI+uriSuffix;
			...
			String URI = GeneralLighting.MY_URI+uriSuffix;
			...
			String URI = Switch.MY_URI+uriSuffix;
